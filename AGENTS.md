...
This file is the quick-reference operating contract for serde-with-kotlin. The longer
...
serde-with-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`serde_with`](https://crates.io/crates/serde_with). Upstream Rust is the behavioral oracle while the
