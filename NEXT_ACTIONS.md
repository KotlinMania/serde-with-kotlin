...
- **Files Present:** 16/72 (22.2%)
- **Function parity:** 13/1369 matched (target 128) — 0.9%
- **Class/type parity:** 17/433 matched (target 107) — 3.9%
- **Combined symbol parity:** 30/1802 matched (target 235) — 1.7%
...
| Source | Target | Path |
|--------|--------|------|
| `serde_as.lib` | `serdewith.BoolFromInt` | `serde_with/tests/serde_as/lib` |
| `serde_with.lib` | `serdewith.Mod` | `serde_with/src/lib` |
| `derives.lib` | `serdewith.OneOrMany` | `serde_with/tests/derives/lib` |
