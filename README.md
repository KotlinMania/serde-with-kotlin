# serde-with-kotlin in Kotlin

[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Fserde--with--kotlin-blue.svg)](https://github.com/KotlinMania/serde-with-kotlin)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.kotlinmania/serde-with-kotlin)](https://central.sonatype.com/artifact/io.github.kotlinmania/serde-with-kotlin)
[![Build status](https://img.shields.io/github/actions/workflow/status/KotlinMania/serde-with-kotlin/ci.yml?branch=main)](https://github.com/KotlinMania/serde-with-kotlin/actions)

This is a Kotlin Multiplatform line-by-line transliteration port of [`jonasbb/serde_with`](https://github.com/jonasbb/serde_with/).

**Original Project:** This port is based on [`jonasbb/serde_with`](https://github.com/jonasbb/serde_with/). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
## Upstream README — `jonasbb/serde_with`

> The text below is reproduced and lightly edited from [`https://github.com/jonasbb/serde_with/`](https://github.com/jonasbb/serde_with/). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
* Apache License, Version 2.0 ([LICENSE-APACHE](https://github.com/jonasbb/serde_with/blob/HEAD/LICENSE-APACHE) or http://www.apache.org/licenses/LICENSE-2.0)
* MIT license ([LICENSE-MIT](https://github.com/jonasbb/serde_with/blob/HEAD/LICENSE-MIT) or http://opensource.org/licenses/MIT)
...
```kotlin
dependencies {
    implementation("io.github.kotlinmania:serde-with-kotlin:0.1.0-SNAPSHOT")
}
```
...
This Kotlin port is distributed under the same MIT license as the upstream [`jonasbb/serde_with`](https://github.com/jonasbb/serde_with/). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.

Original work copyrighted by the serde_with authors.  
Kotlin port: Copyright (c) 2026 Sydney Renee and The Solace Project.

### Acknowledgments

Thanks to the [`jonasbb/serde_with`](https://github.com/jonasbb/serde_with/) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
