...
kotlin {
    ...
    val xcf = XCFramework("SerdeWith")

    macosArm64 {
        binaries.framework { baseName = "SerdeWith"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "SerdeWith"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "SerdeWith"
        flattenPackage = "io.github.kotlinmania.serdewith"
    }

    android {
        namespace = "io.github.kotlinmania.serdewith"
...
mavenPublishing {
    ...
    coordinates(group.toString(), "serde-with-kotlin", version.toString())

    pom {
        name.set("serde-with-kotlin")
        description.set("Kotlin Multiplatform port of jonasbb/serde_with - Custom de/serialization functions for Rust's serde")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/serde-with-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/serde-with-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/serde-with-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/serde-with-kotlin.git")
        }
    }
}
...
// a synthetic JVM-shaped commonMain compile through the CodeQL Java agent.
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.serdewith.codeql
